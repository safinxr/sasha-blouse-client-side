        ...
        <div className='mt-32 black-bg'>
            ...
            ">
                <nav className='flex flex-col leading-6 md:leading-8'>
                    <header className="footer-title uppercase mb-4">User profile</header>
                    <Link to='myaddedfood' className="link link-hover opacity-60">My added food</Link>
                    <Link to='addnewfood' className="link link-hover opacity-60"> Add new food</Link>
                    <Link to='myorderedfood' className="link link-hover opacity-60">My ordered food</Link>
                </nav>
                <nav className='flex flex-col leading-6 md:leading-8 '>
                    <header className="footer-title uppercase mb-4">Navigation</header>
                    <Link to='/' className="link link-hover opacity-60">Home</Link>
                    <Link to='fooditems' className="link link-hover opacity-60">Food Items</Link>
                    <Link to='blog' className="link link-hover opacity-60">Blog</Link>
                </nav >
                ...
                <div className="flex items-center ">
                    <div>
                        <Link to='/'><div className='flex items-center'>
                            <img className='w-14' src="https://i.ibb.co/X5RKNsr/chef.png" alt="" />
                            <p className='agbalumo leading-5 text-xl text-white'>Sasha <br /> Blouse</p>
                        </div>
                        </Link>
                    </div>
                    <div className='ms-4 mt-1 text-sm'>
                        <p className='hidden md:flex'>Best Food Providing since 2023</p>
                        <p className='hidden md:flex'>&copy; 2023 Sasha Blouse All rights reserved.</p>
                    </div>
                </div>
